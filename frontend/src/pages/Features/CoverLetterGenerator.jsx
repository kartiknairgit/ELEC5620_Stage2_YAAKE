      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-3xl">
            Generate personalized, professional cover letters tailored to specific job postings using AI-powered analysis.
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
            ...
            <div className="space-y-4 text-gray-600">
              <p className="leading-relaxed">
                Create compelling cover letters that highlight your relevant skills and experiences.
                Our AI analyzes job descriptions to craft personalized content that resonates with employers.
              </p>
              <p className="leading-relaxed">
                Stand out from other applicants with professionally written cover letters that showcase
                your unique value proposition and align with the company's requirements.
              </p>
            </div>
          </div>
              ...
              {[
                ...
                <li key={index} className="flex items-start group">
                  <div className="flex-shrink-0 mt-1">
                    <div className="h-2 w-2 rounded-full bg-purple-600 group-hover:bg-purple-700 transition-colors duration-200"></div>
                  </div>
        ...
        <div className="mt-8 bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl shadow-lg p-8 text-white">
          <div className="text-center">
            ...
            <p className="text-purple-100 mb-6 max-w-2xl mx-auto">
              We're building an intelligent cover letter generator that learns from successful applications.
              Be the first to know when it launches!
            </p>
            <button className="bg-white text-purple-600 px-8 py-3 rounded-lg font-semibold hover:bg-purple-50 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-0.5">
