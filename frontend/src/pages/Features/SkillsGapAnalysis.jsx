  ...
  return (
    <div className="min-h-full bg-gradient-to-br from-gray-50 to-gray-100 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Coming Soon Section */}
        <div className="mt-8 bg-gradient-to-r from-emerald-600 to-green-600 rounded-xl shadow-lg p-8 text-white">
          <div className="text-center">
            <h3 className="text-2xl font-bold mb-4">Coming Soon</h3>
            <p className="text-emerald-100 mb-6 max-w-2xl mx-auto">
              Map your career journey with intelligent skills analysis.
              Know exactly what to learn to reach your goals.
            </p>
            <button className="bg-white text-emerald-600 px-8 py-3 rounded-lg font-semibold hover:bg-emerald-50 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-0.5">
